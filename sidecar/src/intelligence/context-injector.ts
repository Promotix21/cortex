...
- Project brain (summary, architecture, conventions, known issues)
- Verified code patterns and debug solutions
- Recent errors from dev tools
...
/**
 * Ensure CLAUDE.md in the project root contains a reference to .cortex-context.md.
 * - If no CLAUDE.md exists, create one with the cortex block.
 * - If CLAUDE.md exists but doesn't have the marker, append the block.
 * - If CLAUDE.md already has the marker, leave it alone.
 */
/**
